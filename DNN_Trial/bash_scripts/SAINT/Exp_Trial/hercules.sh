#!/bin/bash
#SBATCH --job-name=SAINT_Hercules
...
for config in "${CONFIGS[@]}"; do
    ...
    srun python3 train.py --config "$config" --model_name SAINT --objective probabilistic_regression --class_comp --batch_size 64 --val_batch_size 128
