#!/bin/bash
#SBATCH --job-name=TabNet_Hercules
...
for config in "${CONFIGS[@]}"; do
    ...
    srun python3 train.py --config "$config" --model_name NODE --objective probabilistic_regression --batch_size 64 --val_batch_size 128
