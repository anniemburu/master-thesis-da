...
for config in "${CONFIGS[@]}"; do
    ...
    python3 /Users/johnmburu/Desktop/Master\ Thesis/master-thesis-da/DNN_Trial/train.py --config "$config" --model_name CatBoost --objective regression --epochs 100 > output_test.log 2>&1
